## About Virt Controller

The Virt Controller is a component of [KubeVirt](https://github.com/kubevirt/kubevirt), which extends Kubernetes with
virtualization capabilities.

The virt-controller watches for VirtualMachineInstance resources and manages their lifecycle, coordinating with the
scheduler and virt-handler to run virtual machines on cluster nodes.
