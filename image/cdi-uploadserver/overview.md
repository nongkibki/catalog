## About CDI Upload Server

The CDI Upload Server is a component of the
...
The cdi-uploadserver component handles the actual upload of virtual machine disk images into PVCs, receiving data from
the upload proxy.
