...
CloudNativePG Barman Cloud Plugin requires cert-manager CRDs to deploy. See https://cert-manager.io/docs/installation/
for details on installing cert-manager.

You can install CloudNativePG Barman Cloud Plugin using the official helm chart and replacing the image. Replace
