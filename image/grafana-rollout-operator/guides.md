...
```bash
docker run --rm -it dhi.io/grafana-rollout-operator:<tag> --help
```
...
```bash
helm upgrade --install test-rollout-operator ghcr.io/grafana/helm-charts/rollout-operator \
...
pod/test-rollout-operator-68dbfcd7fb-xxmwp   1/1     Running   0          50s

NAME                            TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)   AGE
service/kubernetes              ClusterIP   10.43.0.1       <none>        443/TCP   63s
service/test-rollout-operator   ClusterIP   10.43.124.226   <none>        443/TCP   50s

NAME                                    READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/test-rollout-operator   1/1     1            1           50s

NAME                                               DESIRED   CURRENT   READY   AGE
replicaset.apps/test-rollout-operator-68dbfcd7fb   1         1         1       50s
```
...
```
docker debug dhi.io/grafana-rollout-operator:<tag>
```
...
docker run --rm -it --pid container:my-container \
  ...
  dhi.io/grafana-rollout-operator:<tag> /dbg/bin/sh
```
