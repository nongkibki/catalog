...
The Virt API is a component of [KubeVirt](https://github.com/kubevirt/kubevirt), which extends Kubernetes with
virtualization capabilities.

The virt-api component provides a Kubernetes aggregated API server that handles VirtualMachine and related custom
resources, enabling management of virtual machines through the Kubernetes API.
