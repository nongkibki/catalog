...
## Getting started Cilium Clustermesh APIServer
...
### Run a cilium-clustermesh-apiserver container and display help information
...
```
$ docker run --rm -it dhi.io/cilium-clustermesh-apiserver:<tag> help
```
