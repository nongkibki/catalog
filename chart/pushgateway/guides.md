...
```console
helm install my-pushgateway oci://dhi.io/pushgateway-chart --version <version> \
...
default       pod/test-pushgateway-chart-947d44d57-8djdv    1/1     Running   0          19s

NAMESPACE     NAME                             TYPE        CLUSTER-IP   EXTERNAL-IP   PORT(S)                  AGE
default       service/kubernetes               ClusterIP   10.43.0.1    <none>        443/TCP                  35s
default       service/test-pushgateway-chart   ClusterIP   10.43.3.12   <none>        9091/TCP                 19s

NAMESPACE     NAME                                     READY   UP-TO-DATE   AVAILABLE   AGE
default       deployment.apps/test-pushgateway-chart   1/1     1            1           19s

NAMESPACE     NAME                                                DESIRED   CURRENT   READY   AGE
default       replicaset.apps/test-pushgateway-chart-947d44d57    1         1         1       19s
```
