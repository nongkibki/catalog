...
```console
helm install my-reloader oci://dhi.io/stakater-reloader-chart --version <version> \
...
pod/my-reloader-stakater-reloader-chart-9d48d8d6f-98mst     1/1     Running   0          23s

NAME                 TYPE        CLUSTER-IP   EXTERNAL-IP   PORT(S)   AGE
service/kubernetes   ClusterIP   10.96.0.1    <none>        443/TCP   123d

NAME                                                    READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/my-reloader-stakater-reloader-chart     1/1     1            1           23s

NAME                                                              DESIRED   CURRENT   READY   AGE
replicaset.apps/my-reloader-stakater-reloader-chart-9d48d8d6f     1         1         1       23s
```
