...
```console
helm install my-argocd-image-updaer oci://dhi.io/argocd-image-updater-chart --version <version> \
...
pod/test-argocd-image-updater-chart-controller-796b599795-jbgn5   1/1     Running   0          36s

NAME                 TYPE        CLUSTER-IP   EXTERNAL-IP   PORT(S)   AGE
service/kubernetes   ClusterIP   10.43.0.1    <none>        443/TCP   57s

NAME                                                         READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/test-argocd-image-updater-chart-controller   1/1     1            1           36s

NAME                                                                    DESIRED   CURRENT   READY   AGE
replicaset.apps/test-argocd-image-updater-chart-controller-796b599795   1         1         1       36s
```
