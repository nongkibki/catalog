...
```console
helm install my-grafana-agent-operator oci://dhi.io/grafana-agent-operator-chart --version <version> \
...
pod/my-grafana-agent-operator-chart-ccdc9489c-d2h9g   1/1     Running   0          3s

NAME                 TYPE        CLUSTER-IP   EXTERNAL-IP   PORT(S)                        AGE
service/kubelet      ClusterIP   None         <none>        10250/TCP,10255/TCP,4194/TCP   2s
service/kubernetes   ClusterIP   10.43.0.1    <none>        443/TCP                        23s

NAME                                              READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/my-grafana-agent-operator-chart   1/1     1            1           3s

NAME                                                        DESIRED   CURRENT   READY   AGE
replicaset.apps/my-grafana-agent-operator-chart-ccdc9489c   1         1         1       3s
